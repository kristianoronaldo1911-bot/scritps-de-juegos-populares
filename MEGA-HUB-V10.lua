-- MEGA HUB PRO V10 - SE QUEDA DONDE LO ARRASTRES (NO VUELVE AL CENTRO)
...
mainButton.Position = UDim2.new(0.5, -110, 0.5, -30)  -- Posición inicial
...
for i, scriptData in ipairs(scripts) do
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        yesBtn.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(confirm, TweenInfo.new(0.3, Enum.EasingStyle.Back), {
...
-- === ARRASTRAR SIN PEGARSE (BOTÓN) - SE QUEDA DONDE LO SUELTES ===
...
mainButton.InputEnded:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 then
        draggingMain = false
        -- NO vuelve al centro → se queda donde lo dejaste
    end
end)
...
print("MEGA HUB PRO V10 CARGADO! Se queda donde lo arrastras, sin volver al centro.")
